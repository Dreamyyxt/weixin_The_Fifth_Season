...
const PRODUCTS = [
  // ─── 单项服务 (type: service) ─────────────────────────────────────────────
  { _id: 'svc_1', type: 'service', order: 1, name: '卸甲',              duration: '30 分钟',  durationMin: 30,  price: 50,  isVip: false, techIds: [] },
  { _id: 'svc_2', type: 'service', order: 2, name: '纯色美甲（不含甲片）', duration: '60 分钟',  durationMin: 60,  price: 150, isVip: false, techIds: [] },
  { _id: 'svc_3', type: 'service', order: 3, name: '纯色美甲（含甲片）',   duration: '75 分钟',  durationMin: 75,  price: 200, isVip: false, techIds: [] },
  { _id: 'svc_4', type: 'service', order: 4, name: '款式美甲（不含甲片）', duration: '90 分钟',  durationMin: 90,  price: 250, isVip: false, techIds: [] },
  { _id: 'svc_5', type: 'service', order: 5, name: '款式美甲（含甲片）',   duration: '105 分钟', durationMin: 105, price: 300, isVip: false, techIds: [] },
  { _id: 'svc_6', type: 'service', order: 6, name: '足部美甲',            duration: '60 分钟',  durationMin: 60,  price: 180, isVip: false, techIds: [] },
  { _id: 'svc_7', type: 'service', order: 7, name: '美睫',                duration: '90 分钟',  durationMin: 90,  price: 200, isVip: false, techIds: [] },
  { _id: 'svc_8', type: 'service', order: 8, name: '护理',                duration: '45 分钟',  durationMin: 45,  price: 100, isVip: false, techIds: [] },
  // ─── 服务套餐 (type: package) ─────────────────────────────────────────────
  {
    _id: 'pkg_1', type: 'package', order: 10, name: '樱花限定美甲套餐', desc: '日式凝胶 · 春日主题',
    price: 299, points: null, tag: '热销', emoji: '🌸', sold: 128, stock: 999,
    duration: '90 分钟', durationMin: 90,
    techIds: ['tech_1', 'tech_3'],
    features: ['日式凝胶美甲（正片）', '春日主题定制设计', '甲面养护 + 抛光处理'],
  },
  {
    _id: 'pkg_2', type: 'package', order: 11, name: '高级美睫套餐', desc: '嫁接睫毛 + 定妆',
  ...
  {
    _id: 'pkg_3', type: 'package', order: 12, name: '美甲+美睫组合', desc: '双项优惠套餐',
    price: 599, points: null, tag: '优惠', emoji: '✨', sold: 89, stock: 999,
    duration: '180 分钟', durationMin: 180,
    techIds: ['tech_1', 'tech_2', 'tech_3'],
    features: ['日式凝胶美甲 + 嫁接睫毛', '双项同时或分次预约使用', '套餐专属优惠价格'],
  },
  {
    _id: 'pkg_4', type: 'package', order: 13, name: 'VIP 高定全套', desc: 'VIP Room 专属 · 高定款',
    price: 1000, points: null, tag: 'VIP', emoji: '👸', sold: 23, stock: 999,
    duration: '240 分钟', durationMin: 240,
